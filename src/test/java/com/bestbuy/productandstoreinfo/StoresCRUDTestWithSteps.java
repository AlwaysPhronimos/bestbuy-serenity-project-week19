...
import com.bestbuy.buyerinfo.StoresSteps;
...
public class StoresCRUDTestWithSteps extends TestBaseStore {

    static String name = "Smart Shop";
    static String type = "OffLicence";
    static String address = "120, Millcar Drive";
    static String address2 = "High Road";
    static String city = "Harrow";
    static String state = "Leeds";
    static String zip = "LS4 8JP";
